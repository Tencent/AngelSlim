...
#
# ATTRIBUTION: bnhd_pool_kernel + triton_bnhd_pool below are VENDORED from
# MInference (https://github.com/microsoft/MInference @ a4eb395), MIT-licensed,
# (c) 2024-2025 Microsoft — the same upstream as flexprefill's flex_prefill.py.
# They are NOT original AngelSlim work (only comment formatting differs). See
# this package's NOTICE (section 3) and algorithms/minference/kernels/NOTICE for
# the MIT license text. The rest of this file (the VecAttention method) is
# original AngelSlim Apache-2.0 code.
# ---------------------------------------------------------------------------
