...
class SpinQuant(TransformBase):
    ...
    def __init__(self, quant_model, quant_config=None, R1=None, R2=None):
        ...
        self.norm_mapping = _get("norm_mappings", default_norm_mapping)
        self.linear_mapping = _get("mappings", default_linear_mapping)
        ...
        assert self.had_dim == -1, "only support had_dim == -1 now"
