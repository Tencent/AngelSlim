...
#
# Usage:
#   bash scripts/speculative/run_dflash_aligned.sh [NUM_GPUS] [ATTENTION_BACKEND]
#
# ==========================================================================
...
TRAIN_DATA_PATH=${TRAIN_DATA_PATH:-"/cfs_cloud_code/jiebinzhang/SpecForge/cache/dataset/codealpaca-20k_train.jsonl"}
OUTPUT_DIR=${OUTPUT_DIR:-"${ROOT_DIR}/outputs/qwen3-4b-dflash-aligned"}
...
WANDB_RUN_NAME=${WANDB_RUN_NAME:-"angelslim-qwen3-4b-dflash-fp32master-aligned"}
